                                        ...
                                        <div class="ex1">
                                            ...
                                            <?php foreach ($ulasan as $ul) { ?>
                                                ...
                                                <div class="card-body">
                                                  ...
                                                  <br><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal<?= $ul['id_diskusi_tamu'] ?>">Balas</button>&ensp;<a onclick="return confirm('Anda yakin?')" class="btn btn-danger" href="<?= base_url().'admin/Diskusi/hapus_diskusi_tamu/'.$ul['id_diskusi_tamu'] ?>">Hapus</a><hr>
                                                </div>
