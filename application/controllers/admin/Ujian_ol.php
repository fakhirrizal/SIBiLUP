...
class Ujian_ol extends CI_Controller {
	...
	public function soal(){
		...
		$crud->display_as('file','Foto Soal (jpg|jpeg|png)')->display_as('id_mapel','Modul')->display_as('id_guru','Peserta');

		$crud->set_relation('id_mapel','modul','judul');

		$crud->unset_columns('jml_benar','jml_salah','tgl_input','tipe_file','file','bobot');
		...
		$crud->field_type('jawaban','dropdown', array('A' => 'A', 'B' => 'B','C' => 'C' , 'D' => 'D' , 'E' => 'E'));
