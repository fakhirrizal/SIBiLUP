<?php 
	...
	if(!empty($list)){
?>
<div class="bDiv" style="color: #fff;">
...
<?php 
		...
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			...
			<td align="left" width='20%'>
				<div class='tools'>				
					<?php if(!$unset_delete){?>
                    	<a href='<?php echo $row->delete_url?>' title='<?php echo $this->l('list_delete')?> <?php echo $subject?>' class="delete-row" ><span class='delete-icon'></span>
                    	</a>
                    <?php }?>
                    <?php if(!$unset_edit){?>
