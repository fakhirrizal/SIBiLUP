	...
	<!-- 	<div class="mDiv">
	 ...
	 -->	<div id='main-table-box' class="main-table-box">
		...
		<div class="sDiv quickSearchBox" id='quickSearchBox'>
			<div class="sDiv2">
				<input type="text" class="qsbsearch_fieldox search_text" name="search_text" size="30" id='search_text' style="background: white;color: black;text-align: left;padding: 5px;" placeholder="<?php echo $this->l('list_search');?>">
				<select name="search_field" id="search_field" style="background: white;color: black;padding: 5px;">
					<option value=""><?php echo $this->l('list_search_all');?></option>
					<?php foreach($columns as $column){?>
					<option value="<?php echo $column->field_name?>"><?php echo $column->display_as?>&nbsp;&nbsp;</option>
					<?php }?>
				</select>
	            <input type="button" style="width: 50px;" value="<?php echo $this->l('list_search');?>" class="crud_search" id='crud_search'>
			</div>
